...
const poloniexRouter = require('./router/markets');
const binanceRouter = require('./router/markets');
const hitBtcRouter = require('./router/markets');
const gateIoRouter = require('./router/markets');
const bitfinexRouter = require('./router/markets');
const krakenRouter = require('./router/markets');
const coinBaseProRouter = require('./router/markets');
const allMarketsRouter = require('./router/markets');
...
//routers
app.use(poloniexRouter);
app.use(binanceRouter);
app.use(hitBtcRouter);
app.use(gateIoRouter);
app.use(bitfinexRouter);
app.use(krakenRouter);
app.use(coinBaseProRouter);
app.use(allMarketsRouter);
